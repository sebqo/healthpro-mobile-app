...
export const NUTRITION_DATE_PAST_WINDOW_DAYS = 90;
export const NUTRITION_DATE_FUTURE_WINDOW_DAYS = 30;
export const NUTRITION_DATE_WINDOW_SIZE = NUTRITION_DATE_PAST_WINDOW_DAYS + NUTRITION_DATE_FUTURE_WINDOW_DAYS + 1;
